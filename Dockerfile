...
RUN Invoke-WebRequest -OutFile nodejs.zip -UseBasicParsing "https://nodejs.org/dist/latest/node-v14.0.0-win-x64.zip"; Expand-Archive nodejs.zip -DestinationPath C:\; Remove-Item nodejs.zip; Rename-Item "C:\node-v14.0.0-win-x64" c:\nodejs;
